 ...
 *
 * Unlike t510_dma_loopback.c (the v1 single-buffer driver: one-shot RX
 * captures + single-buffer cyclic TX, both requiring a terminate/restart
 * cycle to move to new data), this
