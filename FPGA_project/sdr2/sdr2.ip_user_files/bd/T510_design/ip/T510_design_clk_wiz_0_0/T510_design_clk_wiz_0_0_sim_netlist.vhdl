...
-- Date        : Wed Apr  1 21:31:36 2026
-- Host        : DVLLP006 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top T510_design_clk_wiz_0_0 -prefix
--               T510_design_clk_wiz_0_0_ T510_design_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : T510_design_clk_wiz_0_0
...
entity T510_design_clk_wiz_0_0_T510_design_clk_wiz_0_0_clk_wiz is
  port (
...
end T510_design_clk_wiz_0_0_T510_design_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of T510_design_clk_wiz_0_0_T510_design_clk_wiz_0_0_clk_wiz is
  signal clk_in1_T510_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_T510_design_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_T510_design_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_T510_design_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_T510_design_clk_wiz_0_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_T510_design_clk_wiz_0_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_T510_design_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_T510_design_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_out2_T510_design_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity T510_design_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_out2 : out STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of T510_design_clk_wiz_0_0 : entity is true;
end T510_design_clk_wiz_0_0;

architecture STRUCTURE of T510_design_clk_wiz_0_0 is
begin
inst: entity work.T510_design_clk_wiz_0_0_T510_design_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
