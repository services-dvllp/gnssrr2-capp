...
#
# Script generated by Vivado on Sat Jul 04 22:37:33 +0530 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : T510_design.sh
...
#
# Usage        : T510_design.sh
#                T510_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                T510_design.sh [-reset_run]
#                T510_design.sh [-reset_log]
#                T510_design.sh [-help]
#
...
# script info
echo -e "T510_design.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./T510_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb T510_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./T510_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: T510_design.sh [-help]\n\
Usage: T510_design.sh [-step]\n\
Usage: T510_design.sh [-lib_map_path]\n\
Usage: T510_design.sh [-reset_run]\n\
Usage: T510_design.sh [-reset_log]\n\
Usage: T510_design.sh [-keep_index]\n\
Usage: T510_design.sh [-noclean_files]\n\n\
